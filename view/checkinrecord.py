...
"border-radius:8px;")
    ...
    def retranslateUi(self, CheckInRecordForm):
        ...
        item.setText(_translate("CheckInRecordForm", "学生ID"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("CheckInRecordForm", "学生姓名"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("CheckInRecordForm", "人脸特征"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("CheckInRecordForm", "录入时间"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("CheckInRecordForm", "人脸图片"))
