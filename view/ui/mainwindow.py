...
"}")
        ...
        self.label_author.setGeometry(QtCore.QRect(500, 450, 331, 41))
        font = QtGui.QFont()
        font.setFamily("Roboto")
        font.setPointSize(9)
        font.setBold(False)
        ...
        self.label_author.setStyleSheet("color: rgb(69, 90, 100);\n"
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Student Check-in System"))
        self.pushButton_register.setText(_translate("MainWindow", "人脸录入"))
        self.pushButton_checkin.setText(_translate("MainWindow", "考勤签到"))
        self.label_8.setText(_translate("MainWindow", "Student Check-in System"))
        self.pushButton_exit.setText(_translate("MainWindow", "退出"))
        self.label_9.setText(_translate("MainWindow", "Ver 1.5.1"))
        self.pushButton_face_record.setText(_translate("MainWindow", "人脸信息"))
        self.pushButton_checkin_record.setText(_translate("MainWindow", "考勤记录"))
        self.label_author.setText(_translate("MainWindow", "    Author: BingZhen An       Bulid Time: Nov 2020"))
