...
"border-radius:8px;")
    ...
    def retranslateUi(self, FaceRecordForm):
        ...
        self.pushButton_search.setText(_translate("FaceRecordForm", "查询"))
        self.pushButton_modify.setText(_translate("FaceRecordForm", "修改"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("FaceRecordForm", "学生ID"))
        item = self.tableWidget.horizontalHeaderItem(1)
        item.setText(_translate("FaceRecordForm", "学生姓名"))
        item = self.tableWidget.horizontalHeaderItem(2)
        item.setText(_translate("FaceRecordForm", "人脸特征"))
        item = self.tableWidget.horizontalHeaderItem(3)
        item.setText(_translate("FaceRecordForm", "录入时间"))
        item = self.tableWidget.horizontalHeaderItem(4)
        item.setText(_translate("FaceRecordForm", "人脸图片"))
